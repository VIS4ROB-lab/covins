...
auto ShowParamsBackend()->void
{
    ...
    if(covins_params::placerec::active) {
        std::cout << "type: " << covins_params::placerec::type << std::endl;
    ...
    std::cout << "Cov: " << covins_params::colors::color_cov.mfR << "|" << covins_params::colors::color_cov.mfG << "|" << covins_params::colors::color_cov.mfB << std::endl;
    std::cout << std::endl;
}
