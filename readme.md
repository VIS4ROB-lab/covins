...
## Index
  ...
  - [5 Docker Implementation](#5-docker-implementation)
    ...
    - [Running the Docker Image](#running-the-docker-image)
      - [ROSCORE](#roscore)
      - [COVINS Server Back-End](#covins-server-back-end)
      - [ORB-SLAM3 Front-End](#orb-slam3-front-end)
      - [ORB-SLAM3 ROS Front-End](#orb-slam3-ros-front-end)
      - [ROS Front-End Wrapper (Only for COVINS-G)](#ros-front-end-wrapper-only-for-covins-g)
      - [Terminal](#terminal)
